...
function applyFilters(resetIndex = true) {
  ...
  if (resetIndex && isMobileViewport()) {
    els.settingsDrawer.open = false;
  }
  render();
}
...
function focusQuestionTop() {
  if (!isMobileViewport()) return;
  document.querySelector(".study-panel")?.scrollIntoView({ block: "start", behavior: "smooth" });
}
